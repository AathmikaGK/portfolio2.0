...
function HackathonCard({ item }: { item: Hackathon }) {
  ...
  return (
    <motion.div
      ...
      className="cursor-hover relative glass-card rounded-xl overflow-hidden group flex flex-col"
    >
      <div
        className="pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        style={{
          background: `radial-gradient(360px circle at ${spot.x}px ${spot.y}px, rgba(245,150,99,0.18), transparent 60%)`,
        }}
      />
